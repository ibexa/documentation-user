...
!!! note "[[= pim_product_name =]] integration"
    ...
    When [[[= pim_product_name =]] is configured as the source of product information](quable_integration.md), product categories are synchronized automatically from [[= pim_product_name =]] product classifications into [[= product_name =]].
