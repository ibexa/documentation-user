...
See [Images](https://doc.ezplatform.com/en/1.7/guide/images/) for a technical guide on how to do this.
...
!!! enterprise
    ...
    but [developers can add their own](https://doc.ezplatform.com/en/1.7/guide/landing_page_rendering/#landing-page-blocks). The blocks provided out of the box are:
