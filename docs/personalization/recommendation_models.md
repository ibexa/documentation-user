...
|no attribute specified|The main model is used. The request is handled as if submodels weren't configured at all. Products from the whole shop could appear in the recommendation list.|
