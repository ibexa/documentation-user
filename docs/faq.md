...
See [SiteAccess](https://doc.ezplatform.com/en/2.5/guide/siteaccess/) for more technical information.
...
See [Design](https://doc.ezplatform.com/en/2.5/guide/design_engine/) for more technical information.
...
You can create a new Page in the Page mode by clicking **Create**. See [working with Page](working_with_page.md) for more information.

**What blocks can I add to a Page?**

Here is the list of predefined Page blocks.

You also have the possibility of [creating your own, custom blocks](https://doc.ezplatform.com/en/2.5/guide/extending_page/#creating-custom-page-blocks).
