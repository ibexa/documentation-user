...
For detailed information about content data import, see [Export item information]([[= developer_doc =]]/personalization/enable_personalization/#export-item-information) and [Content API]([[= developer_doc =]]/personalization/developer_guide/content_api/) in the developer documentation.
...
For more information about user attribute import, see [User API]([[= developer_doc =]]/personalization/developer_guide/user_api/) in the developer documentation.
