<div class="front-page">
    ...
    <div class="row mt-5">
        ...
        <div class="col-lg-8 mb-5 latest-release">
            ...
            <div class="row mt-3">
                <div class="col-lg-5">The <a href="https://doc.ibexa.co/en/latest/release_notes/ibexa_dxp_v4.4/">latest version of Ibexa DXP is v4.4</a>. It is a Fast Track release, and it was released on February 2, 2023. You can now <a href="https://doc.ibexa.co/en/latest/update_and_migration/from_4.3/update_from_4.3/">update your application to the latest version</a>.
                </div>
