...
First, you will select a name, predefined design and Parent Location for your site.
...
To preview the site select **Location preview** icon (the eye icon) that is situated next to the site name.
