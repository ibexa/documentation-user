...
Recommendations that are useful in [real-life situations](use_cases.md) are generated by using [scenario strategies](scenarios.md) that consist of algorithms (models).
