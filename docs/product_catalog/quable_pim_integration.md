...
Product types, products, variants, and categories all come from [[= pim_product_name =]].
...
All products from your [[= pim_product_name =]] channel appear in the product catalog, organized by type and category.
