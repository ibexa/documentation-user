...
!!! note
    ...
    For more information about site skeletons, see [Site skeletons](https://doc.ibexa.co/en/master/multisite/site_factory_configuration/#site-skeletons).
...
Unique icons for each Content Type instantly show you what type of content you are selecting. To add custom icons to your Content Tree, follow [configuration tutorial in developer documentation.](https://doc.ibexa.co/en/master/administration/back_office/back_office_elements/custom_icons/#customize-content-type-icons)
...
For more information on custom configuration, go to [Content Tree](https://doc.ibexa.co/en/master/administration/back_office/content_tree/) in developer documentation.
