...
!!! caution
    ...
    (see [the technical documentation on language versions](https://doc.ezplatform.com/en/2.5/guide/internationalization/)).
...
SiteAccess must be [set up by the administrator of the installation](https://doc.ezplatform.com/en/2.5/guide/siteaccess/).
