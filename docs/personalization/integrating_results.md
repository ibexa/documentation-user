...
You can, for example, modify the landing page to include a block that shows what 
...
icon next to a site, in which you want to place a personalization block.
...
 
    ...
    1. On the **Design** tab, in the **View** field, change the layout to "Products" and submit your changes.
      ...
      The preview of your landing page changes to display a list of products recommended by the personalization service.
 
1. Save your changes to the draft or publish the landing page.
