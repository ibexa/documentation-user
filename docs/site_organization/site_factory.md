...
For more information see developer documentation on [Site Factory](https://doc.ibexa.co/en/latest/content_management/url_management/url_management/).
...
For more information about SiteAccesses, see [Multisite](https://doc.ibexa.co/en/latest/multisite/multisite/).
...
!!! note
    ...
    than a SiteAccess defined by the administrator as part of [configuration](https://doc.ibexa.co/en/latest/multisite/multisite_configuration/#siteaccess-configuration). 
