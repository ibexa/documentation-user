...
To access the Back Office (the editor interface), add `/ez` to this address.
...
- **Page** enables you to create and edit block-based Landing Pages. It is only available for eZ Enterprise users.
