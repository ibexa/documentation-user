---
description: Product catalog enables handling of products presented in the website and offered in the storefront, including their specifications and pricing.
---
...
[[[= pim_product_name =]] integration](quable_integration.md) allows you to use [[= pim_product_name =]] as the source of product data, while using [[= product_name =]] for marketing activities, [managing prices](manage_prices.md), and [availability and stock](manage_availability_and_stock.md).
