...
If the [AI Actions](ai_actions.md) feature has been configured in your application, when writing content, the **Improve text** button is visible in the online editor's toolbox.
