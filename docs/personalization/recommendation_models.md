...
Recommendations that prove useful in [real-life situations](use_cases.md) are generated by using a [scenario strategy](scenarios.md) that consists of algorithms.
